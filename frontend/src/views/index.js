//"C:\Users\jh\Documents\GitHub\br\frontend\src\views\index.js"

import React, { useState, useEffect, Fragment } from 'react'
import { Button, Nav, Collapse, Navbar, Container } from 'react-bootstrap'
import Card from '../../src/components/Card' // './Card'가 아니라 '../../src/components/Card'
...
// Import selectors & action from setting store (기존 임포트 유지)
import * => SettingSelector from "../store/setting/selectors";

// Redux Selector / Action (기존 임포트 유지)
import { useSelector } from "react-redux";

// 새로 추가할 컴포넌트 임포트
import WavPredictionCard from '../components/common/WavPredictionCard'; // WavPredictionCard 임포트
